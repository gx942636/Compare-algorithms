...
def net_train(device=None):
    ...
    for epoch in range(epochs):
        ...
        for step, (NOISE_input, GT_label, factor_matrix) in enumerate(train_loader):
        ...
        net.eval()
        with torch.no_grad():
            for step, (NOISE_input, GT_label, factor_matrix) in enumerate(test_loader):
...
if __name__ == "__main__":
    ...
    model_name = 'edhr_rate0.08_40_64_maskfixed'
