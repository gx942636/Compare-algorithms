...
def net_test_2d(net=None, device=None):
    ...
    file_path_recon = f'./Atlg-8p-ft3_slices_recon/{recon_name}.mat'
    savemat(file_path_recon, {'recon_spec': recon_spec})
    label_name = f'label_spec{xulie}'
    file_path_label = f'./Atlg-8p-ft3_slices_recon/{label_name}.mat'
...
if __name__ == "__main__":
    ...
    net = torch.load(r'edhr_rate0.08_64_maskfixed.pth')
    net = net.to(device)
