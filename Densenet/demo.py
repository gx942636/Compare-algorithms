...
class MyDataset(dataset.Dataset):
    ...
    def __getitem__(self, idx):
        NOISE_input, GT_label, factor_matrix, xx_real, xx_imag = self.__gen_signal__(idx)
        ...
        return NOISE_input, GT_label, factor_matrix, xx_real, xx_imag
    ...
    def __gen_signal__(self, idx):
        ...
        # result_formatted = 500
        Mask = scio.loadmat('./0.2_stack_mask-170-768/Mask_' + str(result_formatted) + '.mat')
        Mask = Mask['Mask']
        ...
        xx_real = np.real(NOISE_FID)
        xx_imag = np.imag(NOISE_FID)
